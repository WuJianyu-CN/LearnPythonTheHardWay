'''
    ...
    We can treat a dick like it's a database for storing and organizing data.
    A dictionary is used to map or associate things you want to store to keys you nee to get them.
'''
